...
## 🏛️ The Architecture: "The Holy Trinity"
...
/
├── sql/
│   ├── NDS_REF_SCHEMA_v1_1_6_DIAMOND.sql   # The Factory (Creates Ref Tables)
│   ├── NDS_REF_SEED_v1_1_7_SANITIZED.sql   # The Seed (Populates Ref Data)
│   └── NDS_REL_SCHEMA_v1_2_MATRIX.sql      # The Matrix (Creates Link Table)
├── docs/
│   ├── REF_FRAMEWORK.md                    # Reference Table Standard
